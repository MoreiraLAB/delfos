...
# Calling the integrated single-cell data
ssc = pd.read_csv(DEFAULT_LOCATION + "data/single-cell/integrated_sc.csv")
...
merg.loc[merg['barcode'].str.contains('SCC1'), 'CELL_LINE_NAME'] = 'SCC1'
